...
if($_SERVER["REQUEST_METHOD"]==="POST"){
  ...
  try{
    ...
    $sql = "INSERT INTO `users`( `fullName`, `email`, `password`, `gender`) VALUES (?,?,?,?)";
    $fullname = $_POST["name"];
    $email = $_POST["email"];
    ...
    $stmt->execute([$fullname,$email,$pass, $gender]);
    header("Location: login.php"); // redirect to login after registeration
    die();
